...
import MyInput from '../../basic/input'
import MyInputNumber from '../../basic/input-number'
import MySwitch from '../../basic/switch'
import MyDatePicker from '../../basic/date-picker'
import MyCheckBox from '../../basic/checkbox'
import MyRadio from '../../basic/radio'
import MySelect from '../../basic/select'
import {
  AdvancedControls,
  BasicControls,
  CustomFormItemProps,
  AdvancedControlPropsOption,
} from './types'
...
export class GetControl
  implements GetBasicControlsProps, GetAdvancedControlsProps
{
