...
export interface BasicControlProps<T extends BasicControls>
  extends CustomFormItemProps<T> {
  type: T
}

export interface AdvancedControlProps<T extends AdvancedControls>
  extends CustomFormItemProps<T> {
  type: T
  options: AdvancedControlPropsOption[]
}

export interface CustomControlProps<T extends undefined>
  extends CustomFormItemProps<T> {
  type?: T
}
